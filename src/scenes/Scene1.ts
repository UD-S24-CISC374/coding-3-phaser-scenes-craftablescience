...
export default class Scene1 extends Phaser.Scene {
    ...
    create() {
        ...
        this.add.image(this.cameras.main.displayWidth / 2, this.cameras.main.displayHeight / 2, 'bg1');

        this.add.image(200, 300, 'case').setScale(0.6);
        this.add.image(550, 400, 'cover').setScale(0.25);
        this.add.image(1000, 350, 'guy').setScale(0.4);
