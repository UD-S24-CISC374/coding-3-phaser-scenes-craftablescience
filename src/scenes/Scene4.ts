...
export default class Scene2 extends Phaser.Scene {
    ...
    create() {
        ...
        this.add.image(this.cameras.main.displayWidth / 2, this.cameras.main.displayHeight / 2, 'bg4');

        this.add.image(this.cameras.main.displayWidth / 2, this.cameras.main.displayHeight / 2, 'race').setScale(0.8);
